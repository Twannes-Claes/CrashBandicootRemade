...
void ModelComponent::ShadowMapDraw(const SceneContext& sceneContext)
{
	...
	if (m_enableShadowMapDraw == false) return;
	...
	//1. Call ShadowMapRenderer::DrawMesh with the required function arguments BUT boneTransforms are only required for skinned meshes ofcourse..
